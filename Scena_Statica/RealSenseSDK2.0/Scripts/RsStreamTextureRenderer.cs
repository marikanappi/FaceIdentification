...
public class RsStreamTextureRenderer : MonoBehaviour
{
    ...
    private Frame _latestFrame;      // AGGIUNTO

    public Frame LatestFrame => _latestFrame;    //AGGIUNTO
    ...
    void OnDestroy()
    {
        ...
        _latestFrame?.Dispose(); // Aggiunto
        _latestFrame = null; // Aggiunto
    }
